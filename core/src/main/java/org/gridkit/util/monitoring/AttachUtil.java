...
public class AttachUtil {
	...
	/**
	 * Call this to ensure that tools.jar in classpath.
	 * Method is doing nothing but ensures static initializer is called.
	 */
	public static void ensureToolsClasspath() {
		// do nothing;
		try {
			VirtualMachine.class.toString();
		}
		catch(NoClassDefFoundError e) {
			System.err.println("tools.jar is not available. Make sure that you are running java executable from JDK");
			System.exit(1);
		}
	}
	
	/**
	 * This is a hack to add tools.jar to classpath at runtime.
	 */
